...
| **W2** — "15/15 direction stable" claim needed to be rewritten as 19/20 after adding the v1.7.0 N=2 rerun (4/5 at N=2 + 5/5 at N=16/32/64) | Code-review | Task 8 (seed-claim fix) | `d487735` | Closed: abstract now reads "19/20 pairwise seeds including the v1.7.0 N=2 rerun" |
...
all v1.6.0 headline numbers (15/15 → now 19/20 direction
